...
export default function ExtractFirstPageTool() {
  ...
  type: "application/pdf",
      ...
      link.href = url;
      link.download = "first-page.pdf";
      link.click();

      URL.revokeObjectURL(url);
    } catch (error) {
      console.error(error);
      alert("Failed to extract first page.");
    } finally {
      setLoading(false);
    }
  }
