...
export default function RemovePdfPagesTool() {
  ...
  async function removePages() {
    ...
    if (!pages.trim()) {
      alert("Please enter pages to remove. Example: 2,4,7-10");
      return;
    }
    ...
    try {
      ...
      const pagesToRemove = parsePages(pages, totalPages);
...
const blob = new Blob([new Uint8Array(newBytes)], {
  type: "application/pdf",
      ...
      console.error(error);
      alert("Invalid page selection. Use format like 2,4,7-10.");
    } finally {
      setLoading(false);
    }
  }
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <div className="mt-6">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Use commas and ranges. Example: 2,4,7-10
            </p>
          </div>
